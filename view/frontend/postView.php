    ...
    <div class="news">
        <div class="card border-secondary mb-3">
            <div class="card-header">
                <h4 class="card-title">
                    <a class="card-link"
                       href="../<?= $post['id'] ?>/<?= $post['slug'] ?>"> <?= htmlspecialchars($post['title']) ?></a>
            ...
            <div class="card-body">
                ...
                <div class="card-text">
                    ...
                    if (isset($_SESSION['email'])) {
                        ?>
                        <p class="text-right">
                            <a href="../modifier-article/<?= $post['id'] ?>">
                            ...
                            <a href="../supprimer-article/<?= $post['id'] ?>" class="toConfirm"
                               data-message="Êtes-vous sûr de vouloir supprimer cet article ? Les commentaires qu'il contient seront également supprimés.">
                                <div class="btn btn-warning disabled">Supprimer</div>
                            </a>
                        </p>
                    <?php }
                    ?>
            ...
            <div class="modal-header"><h4 id="commentaires">Commentaires</h4></div>
